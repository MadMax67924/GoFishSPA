    ...
    if (productCount[0].count === 0) {
      ...
      const products = [
        [
          ...
          8990.00,
          "/Salmon portada.jpg?height=400&width=400",
          "pescados",
          0,
          true,
        ],
        [
          ...
          12990.00,
          "/atun portada.jpg?height=400&width=400",
          "pescados",
          25,
          true,
        ],
        [
          ...
          5990.00,
          "/merluza austarl portada.png?height=400&width=400",
          "pescados",
          40,
          false,
        ],
        [
          ...
          "Camarones ecuatorianos de cultivo, perfectos para cócteles y paellas. Tamaño jumbo.",
          15990.00,
          "/camarones ecu portada.jpg?height=400&width=400",
          "mariscos",
          30,
          true,
        ],
        [
          "Pulpo Español",
          "Pulpo español cocido, listo para ensaladas y tapas. Textura perfecta y sabor auténtico.",
          18990.00,
          "/pulpo portda.png?height=400&width=400",
          "mariscos",
          15,
          false,
        ],
        [
          "Congrio Dorado",
          "Congrio dorado fresco, ideal para caldillo y frituras. Pescado tradicional chileno.",
          9990.00,
          "/congrio portada.png?height=400&width=400",
          "pescados",
          35,
          false,
        ],
        [
          "Choritos",
          "Choritos frescos de la zona, perfectos para preparar a la marinera. Sabor intenso del mar.",
          4990.00,
          "/chorito portada.jpg?height=400&width=400",
          "mariscos",
          60,
          false,
        ],
        [
          "Reineta",
          "Reineta fresca, pescado blanco de sabor suave ideal para hornear. Muy versátil en la cocina.",
          6490.00,
          "/reineta portada.jpg?height=400&width=400",
          "pescados",
          45,
          true,
        ],
        [
          "Langostinos",
          "Langostinos frescos de gran tamaño, perfectos para ocasiones especiales. Sabor exquisito.",
          22990.00,
          "/langostino portada.jpg?height=400&width=400",
          "mariscos",
          20,
          true,
        ],
        [
          "Corvina",
          "Corvina fresca, pescado de carne firme ideal para ceviches y preparaciones al vapor.",
          7990.00,
          "/corvina portada.jpg?height=400&width=400",
          "pescados",
          30,
          false,
        ],
